document.addEventListener('DOMContentLoaded', () => {
  ...
  //
  //     if (bounds.top < 1 && typo_bounds.top - anchors_height + typo_height
  //         > 0) {
  ...
  //
  //       if (bounds.top < 1 + trigger_offset && past_anchors.indexOf(key)
  //           === -1) {
  //         past_anchors.push(key);
  //         highlightAnchor();
  //         return;
  //       } else if (bounds.top > trigger_offset && past_anchors.indexOf(key)
  //           !== -1) {
